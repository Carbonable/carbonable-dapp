    ...
    return (
        <div className="mx-auto md:mt-12 lg:mt-6 max-w-7xl">
            <div className="relative w-11/12 mx-auto border border-neutral-700 bg-launchpad-header rounded-3xl p-8 flex items-start justify-start flex-wrap md:px-10">
                <div className="flex items-start justify-start flex-wrap w-full md:w-5/12">
                    <div className="font-trash text-lg uppercase w-full lg:text-xl">My farming assets</div>
                ...
                <div className="flex items-start justify-start flex-wrap w-full mt-8 md:w-5/12 md:mt-0">
                    <div className="font-trash text-lg uppercase w-full lg:text-xl">End of current cycle</div>
