        ...
        <div className="border rounded-lg border-opacityLight-20">
            ...
            <div className="py-4 px-4 border-opacityLight-20">
                <div className="flex items-center">
                    ...
                    <label 
                        htmlFor="crypto" 
                        className={`flex w-full py-2 px-4 items-center justify-start cursor-pointer rounded-lg border border-neutral-600 uppercase text-sm ${paymentMethod === PaymentMethodValues.CRYPTO ? "bg-neutral-100 text-neutral-900" : "bg-opacityLight-5 text-neutral-100 hover:brightness-110"}`}
                    >
                ...
                <div className="flex items-center mt-2">
                    ...
                    <label 
                        htmlFor="credit_card" 
                        className={`flex w-full py-2 px-4 items-center justify-start cursor-pointer rounded-lg border border-neutral-600 uppercase text-sm ${paymentMethod === PaymentMethodValues.CREDIT_CARD ? "bg-neutral-100 text-neutral-900" : "bg-opacityLight-5 text-neutral-100 hover:brightness-110"}`}
                    >
