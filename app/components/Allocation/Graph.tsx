...
export default function AllocationGraph({yearStep, data}: {yearStep: number, data: any[]}) {
    ...
    return (
        <div className="w-full px-0 mt-8 min-h-[300px]">
            <ResponsiveContainer width="100%" height="100%" className="min-h-[300px]">
                ...
                >
                    ...
                    <Bar dataKey="ex_post" name="Ex Post" yAxisId="left" stackId="a" barSize={12} fill="#046B4D" />
                    <Bar dataKey="ex_ante" name="Ex Ante" yAxisId="left" stackId="a" barSize={12} fill="#06A475" radius={[10, 10, 0, 0]} />
