...
const secondaryButton = 'font-inter uppercase rounded-lg px-4 py-2 text-xs text-neutal-100 border border-neutral-500 tracking-wide hover:bg-opacityLight-5 md:px-6 md:py-3 xl:text-sm ';
