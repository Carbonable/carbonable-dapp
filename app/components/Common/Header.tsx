            ...
            <div className="flex items-center justify-center mx-auto w-11/12 lg:w-full pt-4 lg:px-4">
                ...
                <div className="w-3/12 lg:w-full flex justify-end items-center">
                    { resolvedPath.pathname.split( '/' ).length > 2 && 
                        <div className="items-center hidden lg:block absolute left-[250px]">
                            <span className="flex cursor-pointer text-neutral-200 hover:text-neutral-400" onClick={() => navigate(`/${resolvedPath.pathname.split( '/' )[1]}`)}>
